 ...
 */
export async function addEmailFooter(htmlContent, recipientEmail, baseUrl = 'https://billionairs-luxury.vercel.app') {
    ...
    const footer = `
        <div style="margin-top: 50px; padding-top: 30px; border-top: 1px solid #333;">
            <p style="font-size: 12px; color: #888; text-align: center; line-height: 1.6;">
                ...
                <a href="${unsubscribeLink}" style="color: #d4af37; text-decoration: none;">
        ...
        <tr>
            <td align="center" style="padding: 40px 20px;">
                <table width="600" cellpadding="0" cellspacing="0" style="background-color: #1a1a1a; border-radius: 12px; overflow: hidden;">
                    <!-- Header -->
                    <tr>
                        <td style="padding: 30px; text-align: center; background: linear-gradient(135deg, #d4af37 0%, #f2d06b 100%);">
