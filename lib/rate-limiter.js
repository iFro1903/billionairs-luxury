...
export const RATE_LIMITS = {
    ...
    // 2FA Verify: 5 attempts per 15 minutes (Brute-Force-Schutz für TOTP)
    TWO_FA_VERIFY: {
        maxRequests: 5,
        windowMs: 15 * 60 * 1000,
        endpoint: '2fa-verify',
    ...
    // 2FA Setup: 3 attempts per 15 minutes
    TWO_FA_SETUP: {
        maxRequests: 3,
        windowMs: 15 * 60 * 1000,
        endpoint: '2fa-setup',
    ...
    // Password Reset (Token-Einlösung): 5 attempts per 15 minutes
    PASSWORD_RESET_SUBMIT: {
        maxRequests: 5,
        windowMs: 15 * 60 * 1000,
        endpoint: 'password-reset-submit',
        message: 'Too many password reset attempts. Please try again in 15 minutes.'
    },

    // Auto-Login: 5 attempts per 15 minutes
    AUTO_LOGIN: {
        maxRequests: 5,
        windowMs: 15 * 60 * 1000,
        endpoint: 'auto-login',
    ...
    // Admin Destructive Actions: 3 per hour
    ADMIN_DESTRUCTIVE: {
        maxRequests: 3,
        windowMs: 60 * 60 * 1000,
        endpoint: 'admin-destructive',
        message: 'Too many critical operations. Please try again in 1 hour.'
    },

    // Push Subscribe: 10 per 15 minutes
    PUSH_SUBSCRIBE: {
        maxRequests: 10,
        windowMs: 15 * 60 * 1000,
    ...
    // Send Notification: 5 per minute (Admin only)
    SEND_NOTIFICATION: {
        maxRequests: 5,
        windowMs: 60 * 1000,
