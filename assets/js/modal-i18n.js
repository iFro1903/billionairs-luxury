...
const modalTranslations = {
    ...
    en: {
        titles: {
            'FAQ': 'FAQ',
            'What is BILLIONAIRS?': 'What is BILLIONAIRS?',
            'Why the investment?': 'Why the investment?',
            'Who is this for?': 'Who is this for?',
            'Security & Privacy': 'Security & Privacy',
            'What you may gain': 'What you may gain',
            'How long does access take?': 'How long does access take?',
            'Can I see examples or testimonials?': 'Can I see examples or testimonials?',
            ...
            'Access & Eligibility': 'Access & Eligibility',
        ...
        content: {
            'legal_entity_title': 'BILLIONAIRS',
            'legal_entity_subtitle': 'Premium Digital Experience Platform',
            'legal_entity_location': 'Registered in Zürich, Switzerland',
            'legal_contact_intro': 'Exclusive inquiries only:',
            'legal_contact_email': 'elite@billionairs.luxury',
            'legal_contact_response': 'Response time: 24-48 hours',
            'legal_notice_text': 'All intellectual property rights, designs, and content are protected under international copyright law. Unauthorized reproduction or distribution is strictly prohibited.<br><br>BILLIONAIRS reserves the right to modify offerings, terms, and availability without prior notice. All sales are final.',
            'privacy_collect_text': 'Only essential data required for transaction processing and access fulfillment. All information is encrypted using Swiss banking-grade encryption protocols.',
            'privacy_use_transaction': 'Transaction Processing: Secure verification and completion',
            'privacy_use_access': 'Access Fulfillment: Activation of your exclusive experience',
            'privacy_use_communication': 'Communication: Encrypted correspondence regarding your experience',
            'privacy_use_legal': 'Legal Compliance: Regulatory requirements only',
            'privacy_protection_text': 'End-to-end encryption. Swiss banking standards. Blockchain verification. Zero third-party access. Your information never leaves our secure infrastructure.',
            'privacy_rights_text': 'Access, correction, or deletion of personal data available upon request. Contact: elite@billionairs.luxury',
            'terms_agreement_text': 'By accessing BILLIONAIRS, you acknowledge full understanding and voluntary acceptance of these terms. This constitutes a binding agreement under Swiss law. Continued use indicates informed consent.',
            'terms_transaction_text': 'All engagements are final and binding. By proceeding, you confirm full understanding and acceptance. This experience operates beyond conventional frameworks—commitment is absolute and irrevocable. No reversals, modifications, or reconsiderations are possible once initiated.',
            'terms_access_text': 'Restricted to qualifying individuals. BILLIONAIRS reserves absolute discretion in granting or denying access without explanation or recourse. Criteria remain confidential. Participation is a privilege, not a right.',
            'terms_ip_text': 'All designs, concepts, and content are proprietary assets under international copyright and trademark law. Unauthorized reproduction, distribution, or use is strictly prohibited and subject to legal action.',
            'terms_liability_text': 'BILLIONAIRS, its operators, and affiliates assume no liability for direct, indirect, incidental, consequential, or punitive damages arising from your participation. You assume full responsibility for your decisions. This service is provided "as is" without warranties of any kind.',
            'terms_inquiries_email': 'elite@billionairs.luxury',
            'faq_what_is': 'An access point to experiences that exist beyond public reach. Not a marketplace. Not a service. A threshold to moments and access that cannot be replicated, advertised, or explained to those who haven\'t crossed it.<br><br>Think of it as the final collection—not of objects, but of perspective. Of transformation. Of access to realms where currency holds no meaning because what\'s offered cannot be purchased by any other means.<br><br>What lies beyond is yours to discover—but only when you\'re ready.',
            'faq_why_investment': 'True exclusivity requires commitment. What you access here isn\'t sold—it\'s granted. The threshold exists to ensure only those who understand value beyond price ever cross it.<br><br>Collectors of rare experiences know: the barrier itself is part of the curation. It\'s not designed to extract—it\'s designed to protect. To preserve the integrity of what lies beyond from those who measure worth in conventional terms.<br><br>If the commitment feels steep, you\'re exactly where you should be: questioning. That hesitation is the filter. A threshold that reshapes your perception of what access truly means.',
            'faq_who_for': 'Those who have transcended conventional success. Individuals for whom money is no longer a question, but meaning is. People who have acquired everything publicly available and now seek what isn\'t.<br><br>Seekers of what exists between thought and reality. Those who understand that the rarest experiences don\'t appear in catalogs, aren\'t reviewed online, and leave no trace except in the transformation of those who encounter them.<br><br>If you\'re still measuring your worth by your portfolio, this isn\'t your moment yet.',
            'faq_security': 'Zero-knowledge architecture. Swiss banking-grade encryption protocols. Your identity, your transaction, your access—protected to the maximum extent technically possible.<br><br>Minimal records. Minimal trace. We exist in the spaces between systems, where discretion isn\'t a feature—it\'s the foundation.',
            'faq_what_gain': 'No product. No service. No membership. Access to an exclusive digital experience crafted for those who exist beyond conventional boundaries.<br><br>What that becomes in your hands is entirely yours to shape. Only the experience itself. A shift in perspective that can\'t be purchased elsewhere. No records beyond what\'s legally required. No sharing. No proof it ever existed—except in what it may unlock within you.<br><br>The experience is the transformation. Everything else is just context.',
            'faq_access_time': 'Your access begins with the commitment. Full experience typically delivered within 2-3 days.<br><br>The interval is not a delay—it\'s preparation. By design. Some things cannot be rushed without diminishing their essence. The wait is part of the curation, ensuring what you receive has been calibrated to the exact moment your readiness is confirmed.<br><br>True exclusivity operates on its own timeline.',
            'faq_testimonials': 'No. If we showed what participants experienced, it would defeat the very essence of what we offer. Discretion isn\'t a policy—it\'s the product.<br><br>Those who\'ve crossed this threshold understand why silence protects value. The moment exclusivity is publicly proven, it ceases to be exclusive. That\'s the paradox: the most valuable experiences are the ones that leave no proof except in the eyes of those who lived them.<br><br>You\'re not buying proof. You\'re buying the absence of it.',
            'faq_change_mind': 'Commitment is designed to be binding. Not as punishment, but as protection—for you and for the integrity of what you\'re accessing. The finality ensures only those who are truly ready ever cross.<br><br>However: In certain jurisdictions, statutory withdrawal rights may apply—please consult applicable consumer protection laws in your region before committing.<br><br>Hesitation is your last exit. Use it wisely.',
            'faq_availability': 'Because true exclusivity cannot scale. What we offer requires discretion, curation, and absolute focus on each individual who enters.<br><br>This operates on principles beyond supply and demand. When the parameters are met, access closes. Not artificially—inevitably. Scarcity here isn\'t manufactured. It\'s structural.',
            'faq_is_real': 'You don\'t. That\'s the point. Trust isn\'t built through testimonials, guarantees, or proof. It\'s earned through the gravity of the decision itself.<br><br>Many valuable experiences in history operated this way: private experiences that demanded faith before evidence. Those who hesitated read about them later. Those who acted—they lived them.<br><br>If you need validation, you\'re not ready. If you feel the pull despite the uncertainty—then you already know.'
        }
    }
};
